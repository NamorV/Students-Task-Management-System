...
<div class="container">
    ...
    <form name="set-due-date" action="set-due-date-${courseId}-${facultyId}" method="POST">
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
        <ul>
            <li><label>Due date:</label> <input type='date' name='dueDate' /></li>
            <li><label>&nbsp;:</label> <input type="submit" value="Set" class="btn"></li>
        </ul>
    </form>
</div>
